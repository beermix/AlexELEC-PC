...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs zip unzip pciutils usbutils parted procps-ng wget"
...
makeinstall_target() {
  ...
  mkdir -p $INSTALL/usr/lib/alexelec
    cp $PKG_DIR/scripts/functions $INSTALL/usr/lib/alexelec
    cp $PKG_DIR/scripts/fs-resize $INSTALL/usr/lib/alexelec
    sed -e "s/@DISTRONAME@/$DISTRONAME/g" \
        -i $INSTALL/usr/lib/alexelec/fs-resize
